...
knitr::include_graphics('../figs/2016-08-11-Inauguracion-Portal-Datos-Abiertos-de-la-Ciudad-de-Cordoba/autoridades.jpg')
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics('../figs/2016-08-11-Inauguracion-Portal-Datos-Abiertos-de-la-Ciudad-de-Cordoba/mesa debate.jpg')
```
